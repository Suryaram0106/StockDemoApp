...
class StocksActivityAdapter(
    ...
    RecyclerView.Adapter<StocksActivityAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.stocks_activity_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        System.out.println("Arrow: "+stock_Rage2[position].toString())
